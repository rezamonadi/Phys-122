...
$1\,\text{cm}$. At each section of the pipe, a vertical tube open to the
atmosphere is attached, forming two water columns that indicate the local
pressure. If the height of the water column above the wider section is $10\,\text{cm}$,
what is the height of the water column above the narrower section? Assume steady, incompressible, non-viscous flow. Air pressure is 100.0 $kPa$. Water density is 1000 $kg/m^3$.
