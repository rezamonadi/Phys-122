...
A horizontal water pipe narrows from a diameter of $3\,\text{cm}$ to a diameter of
$1\,\text{cm}$. The speed of water flow is 10 cm/s in the wider section. At each section of the pipe, a vertical tube open to the
atmosphere is attached, forming two water columns that indicate the local
pressure. The height of the water column above the wider section is $10\,\text{cm}$,
...
\item[(d)] \textbf{(5 points)}   Explain how the height of water columns would have changed, if the water was not moving in the pipe. 
\end{itemize}
\end{document}
