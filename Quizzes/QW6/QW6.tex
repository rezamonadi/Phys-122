...
\begin{center}
\textbf{Physics Quiz -- Chapter 14: Oscillation -- Winter 2026 -- Monadi  -- CP SLO} \\
\vspace{0.2cm}
\vspace{0.4cm}
...
\item[(a)] \textbf{(4 points)}   Find the velocity of water in the narrower section. 
\item[(b)] \textbf{(4 points)}  What is the pressure of water in the narrower section? 
\item[(c)] \textbf{(4 points)}  What is the pressure of water in the wider section? 
\item[(d)] \textbf{(4 points)}  Calculate the height of water column in the wider section. 
\item[(e)] \textbf{(4 points)}  Explain how the height of water columns would have changed, if the there was a less input water volume rate into the pipe. 
\end{itemize}
\end{document}
